...
//  Both arrays are 0-indexed. The 0th key was pressed at the time 0, and every subsequent key was pressed
...
var slowestKey = function(releaseTimes, keysPressed) {
    ...
    for(let i = 1; i < releaseTimes.length; i ++){
        ...
        else if(longestTime === time && longestKey < keysPressed[i] ){
            longestKey = keysPressed[i]
        }
    }
