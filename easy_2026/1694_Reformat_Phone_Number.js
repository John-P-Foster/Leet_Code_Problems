...
var foo = function(number) {
    ...
    while((remaining - current) > 4){
        formatted.push(stripped[current]);
        formatted.push(stripped[current + 1]);
        formatted.push(stripped[current + 2]); 
        formatted.push('-')
        current += 3; 
    }
    ...
    if(remaining - current === 3){
        formatted.push(stripped[current]);
        formatted.push(stripped[current + 1]);  
        formatted.push(stripped[current + 2]);     
    }

    if(remaining - current === 4){
        formatted.push(stripped[current]);
        formatted.push(stripped[current + 1]); 
        formatted.push(`-`);   
        formatted.push(stripped[current + 2]);   
        formatted.push(stripped[current + 3]);    
    }
...
const testCases = [
    ["123-456", "1-23-45 6"],
    ["123-45-67", "123 4-567"],
    ["123-456-78", "123 4-5678"],
    ["123-456-789", "123 4-56789"],
  ] 
