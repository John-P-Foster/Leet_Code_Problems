...
// When rounding, 5 is rounded upward (5 is rounded to 10, 15 is rounded to 20, 25 to 30,
//      and so on).
...
let testNumber = 1; 
for(let[purchaseAmount, expected] of testCases){
    const returned = accountBalanceAfterPurchase(purchaseAmount);
