...
// Explanation: Temperature at 122.11 Celsius converted in Kelvin is 395.26 and converted
//  in Fahrenheit is 251.798.
...
let testNumber = 1; 
for(let[celsius, expected] of testCases){
    const returned = convertTemperature(celsius);
