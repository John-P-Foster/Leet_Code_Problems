...
// Output: 1
// Explanation: 
// - Operation 1: num1 = 10, num2 = 10. Since num1 == num2, we subtract num2 from num1 and 
// get num1 = 10 - 10 = 0.
...
const testCases = [
    ...
    for(let[testNumber, [num1, num2, expected]] of testCases.entries()){
      const returned = countOperations(num1, num2);
