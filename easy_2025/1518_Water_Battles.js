...
var numWaterBottlesOpt = function(numBottles, numExchange){
...
let testNumber = 1; 
for(let[numBottles, numExchange, expected] of testCases){
    const returned = numWaterBottlesOpt(numBottles, numExchange); 
